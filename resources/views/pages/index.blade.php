                ...
                <div class="row center">
                    ...
                    <div class="col-lg-4">
                        <div class="box">
                            <h4>Cengkeh</h4>
                            <br>
                            <p class="lead"><b> ipsum, dolor sit amet consectetur adipisicing elit. Beatae itaque quas iusto
                                eligendi rem porro exercitationem nostrum commodi corporis dolorum.</b></p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="box">
